class CalculationsController < ApplicationController
  ...
  def word_count
    ...
    @word_count = wordarray.size

        # newtext2 = @text.gsub(@special_word,"a|a")
        # wordarray2 = @text.split("|")

        wordarray2 = atext.scan(/\b#{aspecial_word}\b/i)
        wordarray2.length

    @occurrences = wordarray2.length
  ...
  def descriptive_statistics
    ...
    @mean = @sum / @count
        ...
        nnumbers2 = @numbers.collect{|i| (i-@mean)**2}

    @variance = nnumbers2.sum/@count
